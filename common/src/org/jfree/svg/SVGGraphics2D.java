 ...
 *
 * <li>the {@link #getFontMetrics(Font)} and
...
public final class SVGGraphics2D extends Graphics2D {
     ...
     * 
     * @see #setTransformDoubleConverter(DoubleFunction)
     * 
     * @since 5.0
     */
     ...
     * @param converter  the convertor function ({@code null} not permitted).
     * 
     * @see #setGeomDoubleConverter(DoubleFunction)
     * 
     * @since 5.0
     */
   ...
   private String rgbaColorStr(Color c) {
     ...
     * 
     * @see #drawString(String, float, float)
     */
    @Override
