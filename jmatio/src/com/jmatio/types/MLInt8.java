...
public class MLInt8 extends MLNumericArray<Byte>
{
    ...
    {
        super(name, MLArray.mxINT8_CLASS, vals, m );
    }
    /**
     * <a href="http://math.nist.gov/javanumerics/jama/">Jama</a> [math.nist.gov] style: 
     ...
     * 
     * @param dd A 2D array of bytes.
     * @return A 1D array of Bytes.
     */
     ...
     * 
     * @see MLNumericArray#_get(ByteBuffer, int)
     */
    @Override
