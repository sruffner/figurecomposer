                                                                  ...
                                                                  ByteStorageSupport<T>
{
    ...
    /**
     * @param index The index into backing buffer.
     * @return The real value at that index.
     */
    ...
    /**
     * @param index The index into backing buffer.
     * @return The imaginary value at that index.
     */
    ...
    /**
     * @param index Index into backing buffer
    ...
    public String contentToString()
    {
        ...
        for ( int m = 0; m < getM(); m++ )
        {
           ...
           for ( int n = 0; n < getN(); n++ )
           {
               ...
               if ( isComplex() )
               {
                   sb.append("+").append(getImaginary(m, n));
               }
               sb.append("\t");
           }
           sb.append("\n");
