...
interface Schema0Constants
{
   ...
   String MEASURE_REGEX = "(\\+|\\-)?([0-9]+|[0-9]*\\.[0-9]+(E(\\+|\\-)?[0-9]+)?)(in|cm|mm|pt|%|u)";

	/** The token strings for each unit identifier supported by a floating-pt measure attribute. */
   String[] MEASURE_TOKENS = {"in", "cm", "mm", "pt", "%", "u"};
   ...
   String[] PSFONT_CHOICES = {
	 ...
	 */
   String A_SUBSTFONT = "substfont";

	String SUBSTFONT_SERIF = "serif";
	String SUBSTFONT_SANSSERIF = "sans-serif";
	String SUBSTFONT_MONOSPACE = "monospace";

	/** Set of possible values for the <code>A_SUBSTFONT</code> attribute: "serif", "sans-serif", or "monospace". */
   String[] SUBSTFONT_CHOICES = {SUBSTFONT_SERIF, SUBSTFONT_SANSSERIF, SUBSTFONT_MONOSPACE};
   ...
   String A_FONTSIZE = "fontSize";
	 ...
	 */
   String A_FONTSTYLE = "fontStyle";

	String FONTSTYLE_PLAIN = "plain";
	String FONTSTYLE_BOLD = "bold";
	String FONTSTYLE_ITALIC = "italic";
	String FONTSTYLE_BOLDITALIC = "bolditalic";

	/** Set of possible values for the <code>A_FONTSTYLE</code> attribute: "plain", "italic", "bold", or "bolditalic". */
   String[] FONTSTYLE_CHOICES =
	 ...
	 * element of the <em>DataNav</em> graphics model.
	 */
   String A_STROKECOLOR = "strokeColor";
	 ...
	 */
   String A_STROKEWIDTH = "strokeWidth";
   ...
   String[] VALIGN_CHOICES = {VALIGN_TOP, VALIGN_BOTTOM, VALIGN_CENTER};
	 ...
	 */
   String A_BORDER = "border";

	/** The generic attribute value "none". */
   String ATTRVAL_NONE = "none";

	String ADORN_LINETHRU = "linethru";
	String ADORN_LINEUP = "lineup";
	String ADORN_LINEDOWN = "linedown";
	String ADORN_BRACKET = "bracket";
	String ADORN_ARROW = "arrow";
	String ADORN_FILLARROW = "fillArrow";
	String ADORN_THINARROW = "thinArrow";
	String ADORN_FILLTHINARROW = "fillThinArrow";
	String ADORN_WIDEARROW = "wideArrow";
	String ADORN_FILLWIDEARROW = "fillWideArrow";
	String ADORN_REV_ARROW = "reverseArrow";
	String ADORN_REV_FILLARROW = "reverseFillArrow";
	String ADORN_REV_THINARROW = "reverseThinArrow";
	String ADORN_REV_FILLTHINARROW = "reverseFillThinArrow";
	String ADORN_REV_WIDEARROW = "reverseWideArrow";
	String ADORN_REV_FILLWIDEARROW = "reverseFillWideArrow";
	String ADORN_CIRCLE = "circle";
	String ADORN_FILLCIRCLE = "fillcircle";
	String ADORN_BOX = "box";
	String ADORN_FILLBOX = "fillbox";
	String ADORN_DIAMOND = "diamond";
	String ADORN_FILLDIAMOND = "filldiamond";
	String ADORN_TEE = "tee";
	String ADORN_XHAIR = "xhair";
	String ADORN_STAR = "star";
   ...
   String A_SYMBOL = "symbol";
	 ...
	 */
   String A_SYMBOLSIZE = "symbolSize";
	 ...
	 */
   String A_HIDEERRORS = "hideErrors";
   ...
   String A_MIDCAP = "midCap";
	 ...
	 * ("%" or "u") not permitted.
	 */
   String A_MIDCAPSIZE = "midCapSize";
	 ...
	 */
   String A_LINETYPE = "lineType";

	String LINETYPE_HIDDEN = "hidden";
	String LINETYPE_SOLID = "solid";
	String LINETYPE_DOTTED = "dotted";
	String LINETYPE_DASHED = "dashed";
	String LINETYPE_DASHDOT = "dashdot";

	/** Recognized synonyms for the <code>A_LINETYPE</code> attribute. */
   String[] LINETYPE_SYNONYMS = {
   ...
   String A_UNITS = "units";
	 ...
	 */
   String A_LABELOFFSET = "labelOffset";
   ...
   String A_INTV = "intv";
	 ...
	 */
   String A_PERLOGINTV = "perLogIntv";

	/** Recognized synonyms for the <code>A_PERLOGINTV</code> attribute. */
   String[] PERLOGINTV_SYNONYMS = {"all", "even", "odd"};
   ...
   String[] FMT_CHOICES = {ATTRVAL_NONE, FMT_INT, FMT_F1, FMT_F2, FMT_F3};
   ...
   String GRAPH_TYPE_CARTESIAN = "cartesian";
	/** Graph type:  Cartesian with logarithmic x-axis. */
   String GRAPH_TYPE_SEMILOGX = "semilogX";
	/** Graph type:  Cartesian with logarithmic y-axis. */
   String GRAPH_TYPE_SEMILOGY = "semilogY";
	/** Graph type:  Cartesian with both axes logarithmic. */
   String GRAPH_TYPE_LOGLOG = "loglog";
	/** Graph type:  Polar. */
   String GRAPH_TYPE_POLAR = "polar";
	/** Graph type:  Polar with logarithmic radial axis. */
   String GRAPH_TYPE_SEMILOGR = "semilogR";

	/** The set of all supported graph types. */
   String[] GRAPH_TYPE_CHOICES = {GRAPH_TYPE_CARTESIAN, GRAPH_TYPE_SEMILOGX,
   ...
   String SERIES_TYPE_PTS = "points";
	 ...
	 */
   String SERIES_TYPE_TRACE = "trace";
	 ...
	 */
   String SERIES_TYPE_HIST = "histogram";

	/** The set of choices for a data series element's display type. */
   String[] SERIES_TYPE_CHOICES = {SERIES_TYPE_PTS, SERIES_TYPE_TRACE, SERIES_TYPE_HIST};

	/** The "layout" attribute for a graph element selects the axis layout: 1st quadrant, 2nd quadrant, etc. */
   String A_LAYOUT = "layout";

	String GRAPH_LAYOUT_QUAD1 = "quad1";
	String GRAPH_LAYOUT_QUAD2 = "quad2";
	String GRAPH_LAYOUT_QUAD3 = "quad3";
	String GRAPH_LAYOUT_QUAD4 = "quad4";
	String GRAPH_LAYOUT_ALLQUAD = "allQuad";

	/** The set of choices for a graph element's axis layout. */
   String[] GRAPH_LAYOUT_CHOICES = {GRAPH_LAYOUT_QUAD1, GRAPH_LAYOUT_QUAD2,
